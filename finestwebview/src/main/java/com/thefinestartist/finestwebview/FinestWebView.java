...
public class FinestWebView {
  ...
  public static class Builder implements Serializable {
    ...
    /**
     * @param limitParameter text that url must contain to open inside app,
     *                       if url doesn't contain this text it will open in external browser
     * @return builder
     */
    public Builder setLimitParameter(String limitParameter) {
      this.limitParam = limitParameter;
      return this;
    }
